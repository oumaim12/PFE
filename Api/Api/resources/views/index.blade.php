...
<head>
    ...
    <title>Moto Parts Admin - Gestion des Produits</title>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <img src="assets/images/products/plaquette-frein.jpg" alt="Plaquettes de frein" class="img-thumbnail" width="60">
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="product-edit.html" class="btn btn-sm btn-info">
                                ...
                                <tr>
                                    <td>
                                        <img src="assets/images/products/filtre-huile.jpg" alt="Filtre à huile" class="img-thumbnail" width="60">
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="assets/images/products/kit-chaine.jpg" alt="Kit chaîne" class="img-thumbnail" width="60">
                                    </td>
                                    <td>Kit chaîne</td>
                                    <td>KIT-CH-003</td>
                                    <td>Transmission</td>
                                ...
                                <tr>
                                    <td>
                                        <img src="assets/images/products/disque-frein.jpg" alt="Disque de frein" class="img-thumbnail" width="60">
                                    </td>
                                    <td>Disque de frein arrière</td>
                                    <td>DSQ-AR-004</td>
                                    <td>Freinage</td>
                                    <td>75,00 €</td>
                                    <td>
