    ...
    <div class="main-content">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-shopping-cart me-2"></i>Commandes</li>
            </ol>
        </nav>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="search-box">
                                    <input type="text" class="form-control" id="search" name="search" placeholder="Référence, client..." value="{{ request('search') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('commandes.show', $commande->id) }}" class="btn btn-sm btn-info" title="Voir">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('commandes.edit', $commande->id) }}" class="btn btn-sm btn-primary" title="Modifier">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-dark text-light">
                                                    ...
                                                    <div class="modal-body">
                                                        Êtes-vous sûr de vouloir supprimer la commande <strong>{{ $commande->reference }}</strong> ?
                                                    </div>
