                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="schema_id" id="schema_id" required class="form-input">
                                ...
                                @foreach($schemas as $schema)
                                    <option value="{{ $schema->id }}" {{ old('schema_id', request('schema_id')) == $schema->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="quantite" id="quantite" value="{{ old('quantite', 1) }}" min="1" required class="form-input">
